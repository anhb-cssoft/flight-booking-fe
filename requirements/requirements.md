...
- **Architectural decisions** - component structure, state management approach, and data-fetching/rendering strategy (SSR, CSR, Server Components, etc.), with your rationale.
- **Competitor analysis** - summarise the UX and UI patterns you studied from major OTAs (e.g., Trip.com, Booking.com, AirAsia, Expedia) and explain what you adopted or deliberately avoided.
- **AI tools** - which tools you used, how you used them, and where they helped most.
...
- A deployed, working version of the application (Vercel, Netlify, or provider of your choice)
